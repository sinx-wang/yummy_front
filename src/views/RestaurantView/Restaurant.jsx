        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            ...
            <GridContainer>
                ...
                <Button style={{fontSize:"20px",align:"border"}}color="transparent" onClick={this.handleClickMeal}>
                套餐
                </Button>
                &nbsp;&nbsp;
                <Button style={{fontSize:"20px"}} color="transparent" onClick={this.handleClickFood}>
                单品
                </Button>
                </GridItem>
                </GridContainer>
                  ...
                  <TableBody>
                    {this.state.list.map(item => (
                      <TableRow hover>
                        ...
                        {item.num}&nbsp;&nbsp;
                        <Button round color="transparent" style={{padding:"10px"}} onClick={(e)=>{
                            item.num++;
            ...
            <CardFooter>
                <div style={{textAlign:"right",fontSize:"20px",paddingLeft:"80%"}}>
                   总计：{this.state.total}
                </div>
